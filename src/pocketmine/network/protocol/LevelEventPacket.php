...
class LevelEventPacket extends DataPacket{
	...
	const EVENT_SOUND_DROP_ITEM = 1030;
 	...
 	const EVENT_SOUND_ITEMFRAME_TEST = 1042;
 	...
 	const EVENT_SOUND_SKELETON_TEST = 1050;
 	...
 	const EVENT_SOUND_TESTF = 1503;

 	const EVENT_SOUND_TESTA = 3502;
 	const EVENT_SOUND_TESTB = 3200;
 	const EVENT_SOUND_TESTC = 3201;
 	const EVENT_SOUND_TESTD = 3202;
